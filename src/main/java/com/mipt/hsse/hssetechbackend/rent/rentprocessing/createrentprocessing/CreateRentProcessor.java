 ...
 * Therefore, any exception thrown in processCreate() will result in the rollback of the whole transaction and will mean the failure of the creation of the rent.
 */
@FunctionalInterface
